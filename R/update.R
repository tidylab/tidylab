...
#' tidylab_update()
#' }
tidylab_update <- function(recursive = FALSE, repos = getOption("repos")) {

  deps <- tidylab_deps(recursive, repos)
...
#'   Defaults to \code{getOption("repos")}.
#' @export
tidylab_deps <- function(recursive = FALSE, repos = getOption("repos")) {
